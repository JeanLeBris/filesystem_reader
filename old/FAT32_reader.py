...
class FAT32_filesystem_entry:
    ...
    def __init__(self, cluster_value: int, filesystem, contiguous: bool = False, size: int = 0, is_root: bool = False):
        self.first_cluster = cluster_value
        self.filesystem = filesystem
        self.elements: list[FAT32_filesystem_entry] = []
        self.content = bytes()
        ...
        if self.no_FAT_chain:
            ...
            while True:
                ...
                if filesystem.get_FAT_value(cluster_value) == 0xffffffff: # EOF
                    ...
                    break
                elif filesystem.get_FAT_value(cluster_value) == 0x00000001: # Reserved
                    break
                elif filesystem.get_FAT_value(cluster_value) == 0x00000000: # Free cluster
                    break
                else:
    ...
    def process_data(self):
        ...
        while convert_bytes_to_int(self.content, i * 32, 1, "le") != 0x00:
            ...
            if cluster_buffer == 0:
                ...
                self.elements.append(FAT32_filesystem_entry(cluster_buffer, self.filesystem, False, data_length_buffer))
...
class FAT32:
    ...
    root_dir: FAT32_filesystem_entry
    ...
    def analyse_boot_sector(self):
        ...
        self.boot_fat_length = convert_bytes_to_int(boot_sector, 36, 4, "le")
        self.boot_first_cluster_of_root_directory = convert_bytes_to_int(boot_sector, 44, 4, "le")
        self.boot_signature = convert_bytes_to_bytes(boot_sector, 510, 2)
        ...
        self.root_dir = FAT32_filesystem_entry(self.first_cluster_of_root_directory, self, is_root=True)
    ...
    def display_boot_sector_data(self):
        ...
        print("First cluster of root directory : " + str(self.first_cluster_of_root_directory))
    ...
    def get_FAT_value(self, cluster_value: int):
        ...
        if cluster_value >= 0:
            ...
            data = convert_bytes_to_int(data, cluster_value * 4, 2, "le")
    ...
    def get_filesystem_entry(self, input_path: str):
        ...
        filesystem_entry: FAT32_filesystem_entry = self.root_dir
