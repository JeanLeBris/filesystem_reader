...
class exFAT_filesystem_entry:
    ...
    def __init__(self, cluster_value: int, filesystem, contiguous: bool = False, size: int = 0):
        ...
        self.elements: list[exFAT_filesystem_entry] = []
        self.content = bytes()
    ...
    def process_data(self):
        ...
        while convert_bytes_to_int(self.content, i * 32, 1, "le") != 0x00:
            ...
            if convert_bytes_to_int(strand, 0, 1, "le") == 0x81:
                ...
                self.elements.append(exFAT_filesystem_entry(cluster_buffer, self.filesystem, no_FAT_chain_buffer, data_length_buffer))
...
class exFAT:
    ...
    root_dir: exFAT_filesystem_entry
    ...
    def analyse_boot_sector(self):
        ...
        self.boot_fat_length = convert_bytes_to_int(boot_sector, 84, 4, "le")
        ...
        self.bytes_per_sector_shift = 2**convert_bytes_to_int(boot_sector, 108, 1, "le")
        self.sectors_per_cluster_shift = 2**convert_bytes_to_int(boot_sector, 109, 1, "le")
        self.boot_number_of_fats = convert_bytes_to_int(boot_sector, 110, 1, "le")
        ...
        self.root_dir = exFAT_filesystem_entry(self.first_cluster_of_root_directory, self)
    ...
    def get_filesystem_entry(self, input_path: str):
        ...
        filesystem_entry: exFAT_filesystem_entry = self.root_dir
